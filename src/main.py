...
DATA_PATH = 'your path'
VERITE_PATH = 'your path'
EVIDENCE_PATH = 'your path'
SOURCE_EVIDENCE_PATH = 'your path' 
...
extract_encoder_features(data_path=DATA_PATH, images_path=DATA_PATH+'visual_news/origin/', data_name=DATA_NAME, output_path=EVIDENCE_PATH)
...
# re_rank_verite(data_path=VERITE_PATH, data_name="VERITE", output_path="/home/suraj/Suraj_data/relevant-evidence-detection/data/VERITE/")

## Run experiments for the RED-DOT-Baseline which does not leverage irrelevant evidence
## Results are shown in Tables 1 and 2 
for k_fold in [1]:    #change k value as per need
    for num_evidence in [0]:
